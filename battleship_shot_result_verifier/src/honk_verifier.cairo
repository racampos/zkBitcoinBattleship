use super::honk_verifier_circuits::{
    ...
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_16_PUB_21_circuit,
};
...
mod UltraStarknetZKHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_16_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_16_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_16_PUB_21_circuit, vk,
    };
    ...
    impl IUltraStarknetZKHonkVerifier of super::IUltraStarknetZKHonkVerifier<ContractState> {
        fn verify_ultra_starknet_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_16_PUB_21_circuit(
            ...
            let mut scalars: Span<u384> = array![
                ...
                scalar_56, scalar_69, scalar_70, scalar_71, transcript.shplonk_z.into(), scalar_72,
            ]
                .span();
